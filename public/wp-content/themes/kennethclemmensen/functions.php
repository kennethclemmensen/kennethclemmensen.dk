...
add_action('wp_enqueue_scripts', function() : void {
    ...
    $cdnFile = 'https://use.fontawesome.com/releases/v5.8.1/css/all.css';
    $localFile = '/css/fontawesome-5.8.1.min.css';
    ...
    $jquery = 'jquery';
    $cdnFile = 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.0/jquery.min.js';
    $localFile = '/js/libraries/jquery-3.4.0.min.js';
    $version = filemtime(get_template_directory().$localFile);
