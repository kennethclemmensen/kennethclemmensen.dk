...
add_action('wp_enqueue_scripts', function() : void {
    ...
    $cdnFile = 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.8.2/css/all.min.css';
    $localFile = '/css/fontawesome-5.8.2.min.css';
    ...
    $localFile = '/css/lightbox-2.11.0.min.css';
    $version = filemtime(get_template_directory().$localFile);
    ...
    $jquery = 'jquery';
    $cdnFile = 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js';
    $localFile = '/js/libraries/jquery-3.4.1.min.js';
    $version = filemtime(get_template_directory().$localFile);
    ThemeHelper::addScriptWithLocalFallback($jquery, $cdnFile, get_template_directory_uri().$localFile, $version);

    $vue = 'vue';
    $cdnFile = 'https://cdnjs.cloudflare.com/ajax/libs/vue/2.6.10/vue.min.js';
    $localFile = '/js/libraries/vue-2.6.10.min.js';
    $version = filemtime(get_template_directory().$localFile);
    ...
    $localFile = '/js/plugins/lightbox-2.11.0.min.js';
    $version = filemtime(get_template_directory().$localFile);
