...
add_action('wp_enqueue_scripts', function() : void {
    ...
    $cdnFile = 'https://use.fontawesome.com/releases/v5.7.1/css/all.css';
    $localFile = '/css/fontawesome-5.7.1.min.css';
    ...
    $vue = 'vue';
    $cdnFile = 'https://cdnjs.cloudflare.com/ajax/libs/vue/2.5.22/vue.min.js';
    $localFile = '/js/libraries/vue-2.5.22.min.js';
    $version = filemtime(get_template_directory().$localFile);
